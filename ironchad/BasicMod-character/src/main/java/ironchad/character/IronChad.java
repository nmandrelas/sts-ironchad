...
import static ironchad.BasicMod.characterPath;
import static ironchad.BasicMod.makeID;

public class IronChad extends CustomPlayer {
    //Stats
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass IRONCHAD;
        @SpireEnum(name = "CHARACTER_BLOOD_RED_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "CHARACTER_BLOOD_RED_COLOR") @SuppressWarnings("unused")
        ...
        private static final Color cardColor = new Color(136f/255f, 8f/255f, 8f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new IronChad(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
