...
import ironchad.actions.SappingFireAction;
import ironchad.character.IronChad;
import ironchad.util.CardStats;

public class SappingFire extends BaseCard{
    public static final String ID = makeID(SappingFire.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new SappingFireAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn)));
    }
