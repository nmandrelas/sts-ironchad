...
// Gain deal damage & block equal to masochism
public class DesperateStrike extends BaseCard {
    public static final String ID = makeID(DesperateStrike.class.getSimpleName());
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        ...
        if(power != null){
            addToBot(new GainBlockAction(abstractPlayer, power.amount));
        }
    }
}