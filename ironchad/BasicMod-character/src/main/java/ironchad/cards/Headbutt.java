...
public class Headbutt extends BaseCard {
    public static final String ID = makeID(Headbutt.class.getSimpleName());
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        ...
        this.addToBot(new DiscardPileToTopOfDeckAction(abstractPlayer));
    }
}
