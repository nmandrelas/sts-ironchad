...
public class LifeLeech extends BaseCard{
    public static final String ID = makeID(LifeLeech.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new SappingAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn),1));
    }
}
