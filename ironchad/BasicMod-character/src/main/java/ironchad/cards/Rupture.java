...
/// ironclad rupture
public class Rupture extends BaseCard {
    public static final String ID = makeID(Rupture.class.getSimpleName());
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        this.addToBot(new ApplyPowerAction(abstractPlayer, abstractPlayer, new RupturePower(abstractPlayer, this.magicNumber), this.magicNumber));
    }
