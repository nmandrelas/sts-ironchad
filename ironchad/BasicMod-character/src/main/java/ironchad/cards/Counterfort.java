...
import ironchad.actions.DamageBasedOnBlockAction;
import ironchad.character.IronChad;
import ironchad.util.CardStats;

// Uncommon Gain block, deal damage equal to total block
public class Counterfort extends BaseCard {
    public static final String ID = makeID(Counterfort.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new DamageBasedOnBlockAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn)));
    }
