...
import ironchad.powers.BrandedPower;
import ironchad.util.CardStats;

public class Branded extends BaseCard{
    public static final String ID = makeID(Branded.class.getSimpleName());
    ...
    public Branded() {
        ...
        int DMG = 10;
        int UPG_DMG = 15;
        setMagic(DMG, UPG_DMG);
        this.cardsToPreview = new Burn();
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new BrandedPower(this.magicNumber)));
    }
}