...
public class AppetiteForPain  extends BaseCard{
    public static final String ID = makeID(AppetiteForPain.class.getSimpleName());
    ...
    public AppetiteForPain() {
        super(ID, info); //Pass the required information to the BaseCard constructor.
        setMagic(MAGIC,UPG_MAGIC);
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new MasochismPower(this.magicNumber)));
    }
}