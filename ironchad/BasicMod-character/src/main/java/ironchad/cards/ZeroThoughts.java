...
import ironchad.powers.ZeroThoughtsPower;
import ironchad.util.CardStats;

public class ZeroThoughts extends BaseCard{
    public static final String ID = makeID(ZeroThoughts.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new ZeroThoughtsPower(this.magicNumber)));
    }
}
