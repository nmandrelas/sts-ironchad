...
public class FieryStrike extends BaseCard {
    public static final String ID = makeID(FieryStrike.class.getSimpleName());
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        this.addToBot(new DamageAction(abstractMonster, new DamageInfo(abstractPlayer, this.damage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.FIRE));
